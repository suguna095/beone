...
<tr><td colspan="5"></td><td colspan="3" style="text-align:center;"><strong>Tax Invoice - فاتورة ضريبية</strong></td><td colspan="9"></td></tr>
    ...
    <b>Invoice Date:-&nbsp;<?=$invoiceData[0]['invoice_date'];?> - تاريخ الفاتورة</b>
		...
		$totalgrandShow+=$totalchargeShow+$totalgrandShow;
		$counter=$key+1;
     echo' <tr>
...
<td colspan="17">
   <table align="left" width="30%">
    ...
    <tr><td align="justify">COD Fees - رسوم التحصيل</td><td align="center">SAR <?=$total_collect_add;?></td></tr>

    <tr><td align="justify">Shipment Charges - تكلفة توصيل الشحنات</td><td align="center">SAR <?=$total_service_add;?></td></tr>
     <tr><td align="justify"> Return Charge – رسوم الإرجاع</td><td align="center">SAR <?=$returnCharges;?></td></tr>

    <tr><td align="justify">Bank fees – رسوم التحويل البنكي</td><td align="center">SAR 0</td></tr>
   ...
   <th align="justify">Amount To be Transfered - اجمالي المبلغ الواجب تحويله</th><th >SAR <?=$totalgrandShow;?></th></tr> 
    </table>
    </td>
    </tr>
    </table>
