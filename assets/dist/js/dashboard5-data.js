...
$(document).ready(function() {
	if( $('#m_chart_3').length > 0 ){
		...
		var lineChart = Morris.Line({
				...
				pointSize: 3,
				lineWidth:2,
				pointFillColors:['#3FBEBE','#c3e0a0'],
				pointStrokeColors: ['#3FBEBE','#c3e0a0'],
				lineColors: ['#3FBEBE','#c3e0a0'],
			});	
	}
});
...
var sparklineLogin = function() { 
	...
	if( $('#sparkline_4').length > 0 ){
		$("#sparkline_4").sparkline([20,4,4], {
			...
			height: '50',
			resize: true,
			sliceColors: ['#3FBEBE', '#c3e0a0', '#97ca5a']
		});
	}
